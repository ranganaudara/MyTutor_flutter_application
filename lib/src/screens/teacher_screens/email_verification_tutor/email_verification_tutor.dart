...
class EmailVerificationTutor extends StatefulWidget {
  @override
  _EmailVerificationTutorState createState() =>
      _EmailVerificationTutorState();
}

class _EmailVerificationTutorState extends State<EmailVerificationTutor> {
  ...
  _getPreferences() async {
    ...
    setState(() {
      tutorEmail = prefs.getString("tutorRegEmail");
    });
  }
